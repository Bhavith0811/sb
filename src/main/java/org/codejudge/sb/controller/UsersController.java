...
public class UsersController {
    ...
    @PutMapping("/login")
    @ResponseBody
    public ResponseEntity<SuccessResponse>  login(@RequestBody LoginRequest request) throws CustomException {
        return new ResponseEntity<>(userService.login(request), HttpStatus.OK);
    }

    @PutMapping("/change-password")
    @ResponseBody
    public ResponseEntity<SuccessResponse>  changePassword(@RequestBody ChangePasswordRequest request) throws CustomException {
